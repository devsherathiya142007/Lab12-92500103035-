...
<body>
    ...
    <section id="mission">
        ...
        <ul>
            ...
            <li>Enable graduates to become digital age literates, innovators, and professionals.</li>
            <li>Provide skills, knowledge, and attitudes for success as engineers, leaders, and entrepreneurs.</li>
    ...
    <section id="PSO">
        ...
        <ol>
            <li>Apply knowledge and competence in the design and development of computer-based systems addressing industrial and social needs.</li>
    ...
    <section id="gallery">
        ...
        <div class="gallery-container">
            <!-- Replace the src attributes with actual image paths -->
            <img src=https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRMknAcsZfbNaVIgKUAegsGOIJhZl1Vm0JErRLh_B-PtQ&s=10" alt="Marwadi University Campus">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSRtJTTU5VFZyRlAKpel83WUBONjc9q70mr7ZKcSP0jpg&s=10" alt="Computer Engineering Lab">
            <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSvasw3jxfeVOxkYetVcO672JQ6WXlfH7P8-7qWn7gwFZyui4oLA6XITNw&s" alt="Student Event">
